...
SELECT DISTINCT model FROM sales.products;
SELECT model FROM sales.products;
SELECT count(model) FROM sales.products;
...
SELECT DISTINCT model, model_year FROM sales.products;
SELECT DISTINCT model, model_year FROM sales.products;
